...
const (
	...
	BedrockModelClaudeOpus4_5_20251101   = "anthropic.claude-opus-4-5-20251101-v1:0"
...
func (c *Client) adaptModelForMessage(model anthropic.Model) (string, error) {
	...
	switch model {
	case anthropic.ClaudeOpus4_5_20251101:
		adaptedModel = BedrockModelClaudeOpus4_5_20251101
	...
	case anthropic.ClaudeSonnet4_20250514:
		adaptedModel = BedrockModelClaudeSonnet4_20250514
